                            ...
                            <table class="table table-row-bordered gy-5" id="faqCommonTable">
                                ...
                                <c:if test="${not empty list}">
                                    <c:forEach items="${list}" var="list" varStatus="status">
                                        <tr data-admin-group-log-index="${list.adminGroupLogIndex}" onclick="loadView(this)">
...
<script type="text/javascript">
    ...
    const loadView = (element) => {
        const adminGroupLogIndex = element.getAttribute('data-admin-group-log-index');
        const url = '/log/admin-group-log/' + adminGroupLogIndex;
