                        ...
                        <form name="searchForm" action="" method="get">
                            ...
                            <div class="card mb-7">
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <a class="btn btn-light me-3" href="/business/business-contents-list"><i class="bi bi-arrow-clockwise"></i>초기화</a>
...
<c:out value="${item.businessAreaName}"/>
                                                </td>
                                                <td class="text-dark fw-bold">
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <a class="btn btn-info" href="javascript: location.href='business-contents-reg-form'+location.search;">등록</a>
                            </div>
                        </div>
                    </div>
                    <!--end::Container-->
...
<script type="text/javascript">
    function view(uid) {
        location.href = '/business/business-contents/'+uid+location.search;
    }
