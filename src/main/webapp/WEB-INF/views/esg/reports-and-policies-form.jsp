                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <form name="detailForm" method="post">
                            ...
                            <input type="hidden" name="reportsAndPoliciesIndex" value="${detail.reportsAndPoliciesIndex}"/>
                            <!--begin::Card-->
                            <div class="card mb-7">
                                <!--begin::Card body-->
                                <div class="card-body">
                                    <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px" for="reportsAndPoliciesTitle">게시글 제목</label>
                                        <label class="d-block d-sm-none  required fw-bolder w-xxl-200px" for="reportsAndPoliciesTitle">게시글 제목</label>
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            <input type="text" class="form-control mw-800px" id="reportsAndPoliciesTitle" name="reportsAndPoliciesTitle" placeholder="게시글 제목" required maxlength="50" minlength="1" value="<c:out value="${detail.reportsAndPoliciesTitle}" />">
                                        </div>
                                    </div>
                                    ...
                                    <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px" for="openDate">일자선택</label>
                                        <label class="d-block d-sm-none  required fw-bolder w-xxl-200px" for="openDate">일자선택</label>
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            <div class="input-group input-group-fluid">
                                                <span class="input-group-text"><i class="bi bi-calendar-check text-primary"></i></span>
                                                <input type="text" class="form-control mw-200px flatpickr-input" id="openDate" name="openDate" placeholder="일자" autocomplete="off" required maxlength="10" value="<c:out value="${detail.openDate}" />">
                                            </div>

                                        </div>
                                    </div>
                                    <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px" for="title">Title</label>
                                        <label class="d-block d-sm-none  required fw-bolder w-xxl-200px" for="title">Title</label>
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            <input type="text" class="form-control mw-800px" id="title" name="title" placeholder="Title" required maxlength="50" minlength="3" value="<c:out value="${detail.title}" />">
                                        </div>
                                    </div>
                                    <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        ...
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            ...
                                            ntdrop[0] = global.genDropzone('#dz0', {
                                                params: {
                                                    'ParentTable': 'REPORTS_AND_POLICIES',
                                                    'ParentType': 'PDF_KO',
                                                    'ParentUid': '${uid}',
                                                },
                                                hasOrder: false,
                                                ...
                                                acceptedExt: ['.pdf'],
                                                required: 'N',
                                                errorMsg : 'PDF 파일을 등록해주세요.',
                                                containerId : 'dz0Container',
                                                dropzoneIdx : 'dz0',
                                                maxFileSize : 53,
                                                dropzoneIndex : 0,
                                                messages : {
                                                    empty : 'PDF 파일을 등록해주세요.',
...
<script type="text/javascript">
    ...
    async function saveFormData() {
        ...
        let detailUrl = '/esg/reports-and-policies';
        let url = '/api/v1'+detailUrl;
        let method = 'POST';
        let message = '등록되었습니다.';

        // 수정 모드일 때 변수 조정
        if (document.querySelector('input[name=reportsAndPoliciesIndex]').value !== '') {
            url += '/update/' + uid;
            message = '수정되었습니다.'
        }
...
<script type="text/javascript">
    startFlatpickr = flatpickr(document.detailForm.openDate, {
        dateFormat: 'Y.m.d',
        locale: 'ko',
    });
</script>
