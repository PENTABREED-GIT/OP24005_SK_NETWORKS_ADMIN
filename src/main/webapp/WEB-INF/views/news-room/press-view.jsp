                        ...
                        <div class="card mb-7">
                            ...
                            <div class="card-body">
                                <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                    <label class="col-sm-3 col-md-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px">사업분야</label>
                                    ...
                                    <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row col-form-label">
                                        <c:out value="${detail.businessAreaNameKo}"/>
                                    </div>
                                </div>
                                <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                    <label class="col-sm-3 col-md-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px">등록 메뉴</label>
                                    <label class="d-block d-sm-none  required fw-bolder w-xxl-200px">등록 메뉴</label>
                                    <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row col-form-label">
                                        프레스 센터:&nbsp<c:out value="${detail.isPress}" />,&nbsp;
                                        비즈니스:&nbsp<c:out value="${detail.isBusiness}" />
                                    </div>
                                </div>
                                <div class="py-3 row border-bottom border-gray-200">
                                        ...
                                        <div class="col-sm-9 col-md-10 col-xl-10 col-xxl-9 fv-row col-form-label"><c:out value="${detail.title}"/></div>
                                </div>
                                <div class="py-3 row border-bottom border-gray-200">
                                        <label class="col-sm-3 col-md-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px">등록일</label>
                                        <label class="d-block d-sm-none  required fw-bolder w-xxl-200px">등록일</label>
                                        <div class="col-sm-9 col-md-10 col-xl-10 col-xxl-9 fv-row col-form-label"><c:out value="${detail.regDate}"/></div>
                                </div>
                                <div class="py-3 row border-bottom border-gray-200">
                                ...
                                <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                    ...
                                    <div class="col-sm-9 col-md-10 col-xl-10 col-xxl-9 fv-row fr-view col-form-label">${detail.content}</div>
                                </div>
                                <div class="py-3 row">
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                ...
                                <div class="col d-flex justify-content-end">
                                    ...
                                    <a class="btn btn-warning" href="javascript: location.href='/news-room/press-mod-form/${uid}'+location.search;">수정</a>
                                </div>
                            </div>
                        </div>
                        <!--end::Card-->
