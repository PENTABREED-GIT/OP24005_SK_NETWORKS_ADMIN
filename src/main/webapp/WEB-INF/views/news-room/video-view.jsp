                        ...
                        <div class="card mb-7">
                            ...
                            <div class="card-body">
                                <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                    <label class="col-sm-3 col-md-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px">브랜드</label>
                                ...
                                <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                    <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px">동영상 URL</label>
                                    <label class="d-block d-sm-none  required fw-bolder w-xxl-200px">동영상 URL</label>
                                    <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row col-form-label"><c:out value="${detail.videoUrl}"/></div>
                                </div>
                                <div class="py-3 row">
                                    <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px">영상 스크립트</label>
                                    <label class="d-block d-sm-none fw-bolder required w-xxl-200px">영상 스크립트</label>
                                    <% pageContext.setAttribute("CRLF", "\r\n"); %>
                                    <% pageContext.setAttribute("LF", "\n"); %>
                                    <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row col-form-label">
                                        ${fn:replace(fn:replace(fn:escapeXml(detail.videoScript), CRLF, '<br/>'), LF, '<br/>')}
                                    </div>
                                </div>
                            <!--end::Card body-->
                            <div class="card-footer d-flex justify-content-end">
                                ...
                                <div class="col d-flex justify-content-end">
                                    ...
                                    <a class="btn btn-warning" href="javascript: location.href='/news-room/video-mod-form/${uid}'+location.search;">수정</a>
                                </div>
                            </div>
                        </div>
                        <!--end::Card-->
    ...
    function deleteData(uid) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const response = await fetch('/api/v1/news-room/video/delete/' + uid, {
                    method: 'POST',
                    headers: {
                ...
                if(res.result) {
                    Swal.fire({
                        ...
                        window.location.href = '/news-room/video-list' + location.search;
                    });
                }
            }
        });
