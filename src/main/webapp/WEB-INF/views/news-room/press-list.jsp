                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <form name="searchForm" action="" method="get">
                            ...
                            <div class="card mb-7">
                                    ...
                                    <div id="kt_advanced_search_form" >
                                        ...
                                        <div class="row g-8">
                                            ...
                                            <div class="col-xxl-4 col-xl-6">
                                                ...
                                                <div class="input-group input-group-fluid">
                                                    ...
                                                    <input
                                                        ...
                                                        name="endDate"
                                                        type="text"
                                                        class="form-control flatpickr-input form-control-solid"
                                                        placeholder="종료일"
                                                        autocomplete="off"
                                            ...
                                            <div class="col-xxl-2 col-xl-6 col-md-6">
                                                <label class="fs-6 form-label fw-bolder">사업분야</label>
                                                <!--begin::Select-->
                                                <select class="form-select form-select-solid" name="businessAreaIndex">
                                                    <option value="">전체</option>
                                                <c:forEach var="businessArea" items="${businessAreaList}">
                                                    <option value="${businessArea.businessAreaIndex}" <c:if test="${searchParam.businessAreaIndex eq businessArea.businessAreaIndex}">selected</c:if>>${businessArea.nameKo}</option>
                                                </c:forEach>
                                                </select>
                                                <!--end::Select-->
                                            </div>
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <a class="btn btn-light me-3" href="/news-room/press-list"><i class="bi bi-arrow-clockwise"></i>초기화</a>
                        ...
                        <div class="card">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <c:forEach items="${list}" var="item" varStatus="status">
                                            <tr data-nt-action="goView"  data-uid="${item.uid}" class="text-md-center hoverable" onclick="view('${item.uid}');">
                                                ...
                                                <td class="text-dark fw-bold"><c:out value="${item.businessAreaNameKo}"/></td>
                                                <td class="text-dark fw-bold text-md-start"><c:out value="${item.title}"/></td>
                                                <td class="text-dark fw-bold">${item.isOpenBadge}</td>
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <a class="btn btn-info" href="javascript: location.href='press-reg-form'+location.search;">등록</a>
                            </div>
                        </div>
                    </div>
                    <!--end::Container-->
...
<script type="text/javascript">
    function view(uid) {
        location.href = '/news-room/press/'+uid+location.search;
    }
