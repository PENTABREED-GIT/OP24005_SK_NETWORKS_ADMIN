                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <form name="searchForm" action="" method="get">
                            ...
                            <div class="card mb-7">
                                    ...
                                    <div id="kt_advanced_search_form" >
                                        ...
                                        <div class="row g-8">
                                            ...
                                            <div class="col-xxl-3 col-xl-6">
                                                <label class="fs-6 form-label fw-bolder">최종작업자</label>
                                            ...
                                            <div class="col-xxl-2 col-xl-6 col-md-6">
                                                <label class="fs-6 form-label fw-bolder">연도</label>
                                                <!--begin::Select-->
                                                <select class="form-select form-select-solid" name="year">
                                                    <option value="">전체</option>
                                                <c:forEach var="year" begin="2007" end="2035">
                                                    <option value="${year}" <c:if test="${searchParam.year eq year}">selected</c:if>>${year}</option>
                                                </c:forEach>
                                                </select>
                                                <!--end::Select-->
                                            </div>
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <a class="btn btn-light me-3" href="/ir/audit-report-list"><i class="bi bi-arrow-clockwise"></i>초기화</a>
                        ...
                        <div class="card">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <c:forEach items="${list}" var="item" varStatus="status">
                                            <tr data-nt-action="goView"  data-uid="${item.uid}" class="text-md-center hoverable" onclick="view('${item.uid}');">
                                                ...
                                                <td class="text-dark fw-bold"><c:out value="${item.year}"/></td>
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <a class="btn btn-info" href="javascript: location.href='audit-report-reg-form'+location.search;">등록</a>
                            </div>
                        </div>
                    </div>
                    <!--end::Container-->
...
<script type="text/javascript">
    function view(uid) {
        location.href = '/ir/audit-report/'+uid+location.search;
    }
