                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <form name="searchForm" action="" method="get">
                            ...
                            <div class="card mb-7">
                                    ...
                                    <div id="kt_advanced_search_form" >
                                        ...
                                        <div class="row g-8">
                                            ...
                                            <div class="col-xxl-2 col-xl-6 col-md-6">
                                                <label class="fs-6 form-label fw-bolder">최상단 공지 여부</label>
                                                <!--begin::Radio group-->
                                                <div class="nav-group nav-group-fluid">
                                                    <!--begin::Option-->
                                                    <label>
                                                        <input type="radio" class="btn-check" name="isTop" value=""<c:if test="${searchParam.isTop != 'Y' and searchParam.isTop != 'Y'}"> checked</c:if>/>
                                                        <span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4">전체</span>
                                                    </label>
                                                    <!--end::Option-->
                                                    <!--begin::Option-->
                                                    <label>
                                                        <input type="radio" class="btn-check" name="isTop" value="Y"<c:if test="${searchParam.isTop == 'Y'}"> checked</c:if>/>
                                                        <span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bold px-4">최상단</span>
                                                    </label>
                                                    <!--end::Option-->
                                                    <!--begin::Option-->
                                                    <label>
                                                        <input type="radio" class="btn-check" name="isTop" value="N"<c:if test="${searchParam.isTop == 'N'}"> checked</c:if>/>
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <a class="btn btn-light me-3" href="/ir/announcement-list"><i class="bi bi-arrow-clockwise"></i>초기화</a>
                        ...
                        <div class="card">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <c:forEach items="${list}" var="item" varStatus="status">
                                            <tr data-nt-action="goView"  data-uid="${item.uid}" class="text-md-center hoverable" onclick="view('${item.uid}');">
                                                ...
                                                <td class="text-dark fw-bold text-md-start">
                                                    <c:if test="${item.isTop eq 'Y'}"><span class="badge py-2 px-3 fs-7 badge-light-primary">TOP</span></c:if>
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <a class="btn btn-info" href="javascript: location.href='announcement-reg-form'+location.search;">등록</a>
                            </div>
                        </div>
                    </div>
                    <!--end::Container-->
...
<script type="text/javascript">
    function view(uid) {
        location.href = '/ir/announcement/'+uid+location.search;
    }
