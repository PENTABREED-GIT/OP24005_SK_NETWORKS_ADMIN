                        ...
                        <div class="card mb-7">
                            ...
                            <div class="card-body">
                                <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                    <label class="col-sm-3 col-md-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px">연도</label>
                                ...
                                <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end fw-bolder w-xxl-200px">연결기준</label>
                                        <label class="d-block d-sm-none  fw-bolder w-xxl-200px">연결기준</label>
                                    ...
                                    <div class="py-3 row">
                                        <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end fw-bolder w-xxl-200px">별도기준</label>
                                        <label class="d-block d-sm-none  fw-bolder w-xxl-200px">별도기준</label>
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                ...
                                <div class="col d-flex justify-content-end">
                                    ...
                                    <a class="btn btn-warning" href="javascript: location.href='/ir/audit-report-mod-form/${uid}'+location.search;">수정</a>
                                </div>
                            </div>
                        </div>
                        <!--end::Card-->
    ...
    function deleteData(uid) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const response = await fetch('/api/v1/ir/audit-report/delete/' + uid, {
                    method: 'POST',
                    headers: {
                ...
                if(res.result) {
                    Swal.fire({
                        ...
                        window.location.href = '/ir/audit-report-list' + location.search;
                    });
                }
            }
        });
