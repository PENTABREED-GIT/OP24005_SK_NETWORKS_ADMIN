                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <form name="searchForm" action="" method="get">
                            ...
                            <div class="card mb-7">
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <a class="btn btn-light me-3" href="/ir/ir-schedule-list"><i class="bi bi-arrow-clockwise"></i>초기화</a>
                        ...
                        <div class="card">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <c:forEach items="${list}" var="item" varStatus="status">
                                            <tr data-nt-action="goView"  data-uid="${item.uid}" class="text-md-center hoverable" onclick="view('${item.uid}');">
                                                ...
                                                <td class="text-dark fw-bold"><c:out value="${item.irScheduleType}"/></td>
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <a class="btn btn-info" href="javascript: location.href='ir-schedule-reg-form'+location.search;">등록</a>
                            </div>
                        </div>
                    </div>
                    <!--end::Container-->
...
<script type="text/javascript">
    function view(uid) {
        location.href = '/ir/ir-schedule/'+uid+location.search;
    }
