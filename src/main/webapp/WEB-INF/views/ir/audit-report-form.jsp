                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <form name="detailForm" method="post">
                            ...
                            <input type="hidden" name="auditReportIndex" value="${detail.auditReportIndex}"/>
                            <!--begin::Card-->
                            <div class="card mb-7">
                                <!--begin::Card body-->
                                <div class="card-body">
                                    <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px">연도</label>
                                        <label class="d-block d-sm-none  required fw-bolder w-xxl-200px">연도</label>
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            <select class="form-select mw-300px" aria-label="연도 선택" name="year" required>
                                                <option value="">연도 선택</option>
                                            <c:forEach var="year" begin="2007" end="2035">
                                                <option value="${year}" <c:if test="${detail.year eq year}">selected</c:if>>${year}</option>
                                            </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end fw-bolder w-xxl-200px" for="dz0">연결기준</label>
                                        <label class="d-block d-sm-none  fw-bolder w-xxl-200px" for="dz0">연결기준</label>
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            <div class="row form-check col-form-label form-check-custom mw-1000px" id="dz0Container">
                                                ...
                                                <jsp:include page="/file-form-inc" flush="false">
                                                    ...
                                                    <jsp:param name="parentTable" value="AUDIT_REPORT" />
                                                    <jsp:param name="parentUid" value="${detail.uid}" />
                                                    <jsp:param name="parentType" value="CONSOLIDATION" />
                                            ...
                                            ntdrop[0] = global.genDropzone('#dz0', {
                                                params: {
                                                    'ParentTable': 'AUDIT_REPORT',
                                                    'ParentType': 'CONSOLIDATION',
                                                    'ParentUid': '${uid}',
                                                },
                                                hasOrder: false,
                                                isSecure: 'N',
                                    ...
                                    <div class="py-3 row">
                                        <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end fw-bolder w-xxl-200px" for="dz1">별도기준</label>
                                        <label class="d-block d-sm-none  fw-bolder w-xxl-200px" for="dz1">별도기준</label>
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            <div class="row form-check col-form-label form-check-custom mw-1000px" id="dz1Container">
                                                ...
                                                <jsp:include page="/file-form-inc" flush="false">
                                                    ...
                                                    <jsp:param name="parentTable" value="AUDIT_REPORT" />
                                                    <jsp:param name="parentUid" value="${detail.uid}" />
                                                    <jsp:param name="parentType" value="SEPERATION" />
                                                    <jsp:param name="hasOrder" value="false" />
                                                    <jsp:param name="maxFileCount" value="2"/>
                                                    <jsp:param name="isSecure" value="N"/>
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <div class="col d-flex justify-content-start">
                                        <a class="btn btn-dark" href="javascript: location.href='/ir/audit-report-list'+location.search;">목록</a>
                                    </div>
...
<script type="text/javascript">
    ...
    async function saveFormData() {
        let detailUrl = '/ir/audit-report';
        let url = '/api/v1'+detailUrl;
        let method = 'POST';
        let message = '등록되었습니다.';

        // 수정 모드일 때 변수 조정
        if (document.querySelector('input[name=auditReportIndex]').value !== '') {
            url += '/update/' + uid;
            message = '수정되었습니다.'
        }
