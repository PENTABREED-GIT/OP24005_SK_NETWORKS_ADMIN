                        ...
                        <div class="card mb-7">
                            ...
                            <div class="card-body">
                                <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                    <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px">자료 언어</label>
                                    <label class="d-block d-sm-none  required fw-bolder w-xxl-200px">자료 언어</label>
                                    <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row col-form-label">
                                        <c:out value="${detail.dataLangName}"/>
                                    </div>
                                </div>
                                <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                ...
                                <div class="py-3 row">
                                <label class="col-sm-3 col-md-3 col-xl-2 d-none d-sm-block col-form-label text-end fw-bolder w-xxl-200px required">첨부파일</label>
                                <label class="d-block d-sm-none  fw-bolder w-xxl-200px required">첨부파일</label>
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                ...
                                <div class="col d-flex justify-content-end">
                                    ...
                                    <c:choose>
                                    <c:when test="${classification eq 'RESULT' or detail.classification eq 'RESULT'}">
                                    <a class="btn btn-warning" href="javascript: location.href='/ir/management-report-mod-form/${uid}'+location.search;">수정</a>
                                    </c:when>
                                    <c:otherwise>
                                    <a class="btn btn-warning" href="javascript: location.href='/ir/ir-data-mod-form/${uid}'+location.search;">수정</a>
                                    </c:otherwise>
                                    </c:choose>
    ...
    function deleteData(uid) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const response = await fetch('/api/v1/ir/ir-data/delete/' + uid, {
                    method: 'POST',
                    headers: {
                ...
                if(res.result) {
                    Swal.fire({
                        ...
                        <c:choose>
                        <c:when test="${classification eq 'RESULT' or detail.classification eq 'RESULT'}">
                        window.location.href = '/ir/management-report-list' + location.search;
                        </c:when>
                        <c:otherwise>
                        window.location.href = '/ir/ir-data-list' + location.search;
                        </c:otherwise>
                        </c:choose>
