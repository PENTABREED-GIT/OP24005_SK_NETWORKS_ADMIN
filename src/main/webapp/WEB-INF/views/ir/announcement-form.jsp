                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <form name="detailForm" method="post">
                            ...
                            <input type="hidden" name="announcementIndex" value="${detail.announcementIndex}"/>
                            <!--begin::Card-->
                            <div class="card mb-7">
                                <!--begin::Card body-->
                                <div class="card-body">
                                    ...
                                    <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        <label class="col-sm-3 col-md-2 d-none d-sm-block col-form-label text-end required fw-bolder w-xxl-200px" for="openDate">공고일</label>
                                        <label class="d-block d-sm-none  required fw-bolder w-xxl-200px" for="openDate">공고일</label>
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            <div class="input-group input-group-fluid">
                                                ...
                                                <input type="text" class="form-control mw-200px flatpickr-input" id="openDate" name="openDate" placeholder="공고일" autocomplete="off" required value="<c:out value="${detail.openDate}" />">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        <label class="col-sm-3 col-md-2 d-none d-sm-block col-form-label text-end fw-bolder w-xxl-200px" for="isTop">최상단 공지</label>
                                        <label class="d-block d-sm-none fw-bolder w-xxl-200px" for="isTop">최상단 공지</label>
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            <div class="form-check col-form-label form-switch form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox" name="isTop" value="Y" id="isTop"<c:if test="${detail.isTop eq 'Y'}"> checked</c:if>/>
                                            </div>
                                        </div>
                                    </div>
<div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        ...
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            ...
                                            ntdrop[0] = global.genDropzone('#dz0', {
                                                ...
                                                isSecure: 'N',
                                                maxFileCount: 2,
                                                acceptedExt: ['.jpg', '.jpeg', '.png', 'webp', 'gif', 'apng', 'bmp', '.pdf'],
                                                required: 'N',
                                    ...
                                    <div class="py-3 row border-bottom border-bottom-dashed border-gray-200">
                                        ...
                                        <div class="col-sm-9 col-md-9 col-xl-10 col-xxl-9 fv-row">
                                            <div class="row form-check col-form-label form-check-custom mw-1000px" id="dz2Container">
                                                <!-- 파일 업로드 섹션 -->
                                                <jsp:include page="/file-form-inc" flush="false">
                                                    <jsp:param name="viewType" value="${viewType}" />
                                                    <jsp:param name="parentTable" value="ANNOUNCEMENT" />
...
<script type="text/javascript">
    ...
    async function saveFormData() {
        let detailUrl = '/ir/announcement';
        let url = '/api/v1'+detailUrl;
        let method = 'POST';
        let message = '등록되었습니다.';

        // 수정 모드일 때 변수 조정
        if (document.querySelector('input[name=announcementIndex]').value !== '') {
            url += '/update/' + uid;
            message = '수정되었습니다.'
        }
