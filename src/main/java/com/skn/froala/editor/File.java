...
import com.skn.froala.editor.file.FileOptions;
import com.skn.froala.editor.image.ImageOptions;
...
public final class File {
	...
	public static Map<Object, Object> upload(HttpServletRequest req, String fileRoute, FileOptions options)
		...
		//String absoluteServerPath = getAbsoluteServerPath(req, linkName); 20181213 hjkim 아래로.
	...
	public static void delete(HttpServletRequest req, String src) {
		...
		//String filePath = getAbsoluteServerPath(req, src); 20181213 hjkim 아래로.
		String filePath = src;
